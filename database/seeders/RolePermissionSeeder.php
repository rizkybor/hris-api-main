        ...
        DB::transaction(function () {
            ...
            $operationalDirector->syncPermissions(
                $this->permissionsByPrefixes([
                    ...
                    // Subscriptions: Operational Director can see the list
                    // and generate invoices, but not create/edit/delete a
                    // subscription's own terms -- that stays with
                    // Manager/Finance Manager/Superadmin.
                    ->merge(Permission::whereIn('name', [
                        'subscription-menu',
                        'subscription-list',
            ...
            $finance->syncPermissions(
                Permission::whereIn('name', [
                    ...
                    'sdm-resource-edit',
                    'sdm-resource-delete',
                    // Subscriptions: Finance Manager gets full management,
                    // same as Manager/Superadmin -- Operational Director
                    // only gets list+generate (see its own grant below), HR
                    ...
                    'clients-edit',
                    'clients-delete',
                    'clients-attachment-list',
                    'clients-attachment-create',
                    'clients-attachment-edit',
                    'clients-attachment-delete',
                    'clients-task-list',
                    'clients-task-list-create',
                    'clients-task-list-edit',
                    'clients-task-list-delete',
                    'clients-task-scope-list',
                    'clients-task-scope-create',
                    'clients-task-scope-edit',
                    'clients-task-scope-delete',
                    'clients-task-payment-list',
                    'clients-task-payment-create',
                    'clients-task-payment-edit',
                    'clients-task-payment-delete',
                    'clients-task-pivot-list',
                    'clients-task-pivot-create',
                    'clients-task-pivot-edit',
                    'clients-task-pivot-delete',
                    'report-menu',
                    'report-view',
                    'report-export',
                    'purchase-order-menu',
