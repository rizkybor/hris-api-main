...
class VendorsTaskPivotDto
{
    public function __construct(
        ...
        public readonly ?int $scope_vendor_id = null,
        public readonly ?int $task_vendor_id = null,
        public readonly ?int $payment_vendor_id = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            scope_vendor_id: $data['scope_vendor_id'] ?? null,
            task_vendor_id: $data['task_vendor_id'] ?? null,
            payment_vendor_id: $data['payment_vendor_id'] ?? null,
    ...
    public static function fromArrayForUpdate(array $data, VendorsTaskPivot $pivot): self
    {
        return new self(
            ...
            payment_vendor_id: $data['payment_vendor_id'] ?? $pivot->payment_vendor_id,
