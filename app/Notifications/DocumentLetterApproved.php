...
class DocumentLetterApproved extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Official Memo Disetujui')
            ->greeting('Halo '.$notifiable->name.',')
            ->line('Official Memo yang kamu ajukan telah disetujui oleh Finance Manager.')
    ...
    {
        return [
            'title' => 'Official Memo Disetujui',
            'message' => 'Official Memo "'.$this->documentLetter->subject.'" telah disetujui.',
